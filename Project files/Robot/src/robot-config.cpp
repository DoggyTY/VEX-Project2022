...
motor LeftDriveMotorB = motor(PORT12, ratio18_1, false);
...
motor IntakeMotorsMotorA = motor(PORT3, ratio6_1, false);
motor IntakeMotorsMotorB = motor(PORT4, ratio6_1, true);
